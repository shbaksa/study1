...
public class String1 {
	public static void main(String[] args) {
		...
		// replace() : 문자열을 내용을 바꾸기 //  똑같은 문자열이 있을경우 다 바꿈
		...
		int n1=test.lastIndexOf("a");
		System.out.println("인덱스 : "+n1);
		
		// substring() : 문자열에서 특정부분을 잘라서 리턴
		String ex3="동해물과 백두산이 마르고 닳도록";
		String result=ex3.substring(5,7);
		// 첫번째 인덱스부터 두번째 인덱스의 앞까지 리턴
		System.out.println(result);
		result=ex3.substring(0,3);
		System.out.println(result);
		// 백두산 뒤의 모든 문자 (인수를 하나만 주면 해당 내용 끝까지)
