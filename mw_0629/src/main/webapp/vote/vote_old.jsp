...
<body style="text-align:center;"> <!-- vote.jsp : radio를 이용한 투표 -->
...
<!-- 	<form name="pkc" method="post" action="vote_ok.jsp" onsubmit="return check()">
	...
	<form name="pkc" method="post" action="vote_ok_old.jsp" onsubmit="return check()">
	<input type="hidden" name="id" value="1">
		<p><div><h2>좋아하는 점심 메뉴를 선택해 주세요</h2></div></p>
		<div><input type="radio" name="food" value="p1"> 순대국</div>
		<div><input type="radio" name="food" value="p2"> 부대찌개</div>
		<div><input type="radio" name="food" value="p3"> 짜장면</div>
		<div><input type="radio" name="food" value="p4"> 초 밥</div>
		<div><input type="radio" name="food" value="p5"> 김 밥</div>
		<div><input type="submit" value="투표하기"></div>
	</form>
