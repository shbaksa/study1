...
<body>
		...
		<td> <span class="food" style="width:<%=per1%>px;"></span> <%=p1 %>명</td>
		</tr>
		<tr>
		<td>부대찌개</td>
		<td> <span class="food" style="width:<%=per2%>px;"></span> <%=p2 %>명 </td>
		</tr>
		<tr>
		<td>짜장면</td>
		<td> <span class="food" style="width:<%=per3%>px;"></span> <%=p3 %>명 </td>
		</tr>
		<tr>
		<td>초 밥</td>
		<td> <span class="food" style="width:<%=per4%>px;"></span> <%=p4 %>명 </td>
		</tr>
		<tr>
		<td>김 밥</td>
		<td> <span class="food" style="width:<%=per5%>px;"></span>  <%=p5 %>명</td>
		</tr>
		<tr>
		<td colspan="1" align="right"> 총투표자 </td>
		<td><%=tot %></td>
		</tr>
		<tr>
		<td colspan="2"><input type="button" onclick="lo()" value="투표"></td>
		</tr>
		</table>
