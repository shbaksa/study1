...
<body>
	 ...
	 <tr align="center">
	 <td colspan="2"><input type="button" onclick="location='update1.jsp?id=<%=rs.getInt("id") %>'" value="수정"> </td>
	 ...
	 <td>비밀번호</td>
	 <td colspan="2"><input type="password" name="pwd" placeholder="비밀번호입력"></td>
