...
<body>	<!-- keyup.jsp : 일정길이가 들어오면 다음 폼태그로 이동 -->
	...
	<input type="text" name="card2" maxlength="4" onkeyup="check1(this)" size="3">-
	<input type="text" name="card3" maxlength="4" onkeyup="check2(this)" size="3">-
	<input type="text" name="card4" maxlength="4" onkeyup="check3(this)" size="3">
	</form>
