...
<body>
	...
	<tr>
	<td colspan="2"> <b>제목</b> </td> <!-- 4 -->
	<td colspan="7"> <%=rs.getString("title") %> </td>
	<td colspan="1" align="right"> <form method="post" action="update.jsp">
	<input type="submit" value="수정"></form>
	</tr>
	<tr>
	<td colspan="2"> <b>이름</b> </td> <!-- 4 -->
	...
	<tr>
	<td colspan="10" align="right"> <form method="post" action="list.jsp">
