...
public class ReserveDao3 {
	...
	public ReserveDao3() throws Exception {
	...
	public void reserve_view(HttpServletRequest request, HttpSession session) throws Exception{
		...
		sql = "select r2.*, bang from reserve as r2, room as r1 where "+k+" r2.userid=? &&  r1.id=r2.bang_id order by id desc limit 1";
		pstmt = conn.prepareStatement(sql);		
