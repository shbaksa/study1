...
<title>Insert title here</title>
	<script>
		function init(){
			...
			var chong=mon[month];
			// 윤년일 경우 2월이 29일로 변경
			if(month==1){ // 윤년 구하는식  (year%4 == 0) && (year%100 != 0) || (year%400 == 0)
				if( (year%4 == 0) && (year%100 != 0) || (year%400 == 0) ){ // 년도를 4로 나눈 나머지가 0이면 윤년O 100으로 나눈 나머지가 0이면 윤년X
					chong=29;
				}
			}
			// 몇주
			...
			var cal_data="<table width='300' border='1'>";
