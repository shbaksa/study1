...
<body>	<!--  form1.jsp -->
	...
	<hr>
					<!-- on이벤트="return 메소드() => 해당메소드의 리턴값이 true이면 이벤트가 동작
																	false이면 동작 X -->
	<form name="pkc2" method="post" action="a.jsp" onsubmit="return check2()">
		이름 <input type="text" name="name"> <p>
		비번 <input type="password" name="pwd"> <p>
		소개 <textarea cols="40" rows="5" name="sogae"></textarea><p>
		<input type="submit"  value="확인">		
		<!-- submit은 무조건 action에 있는 문서로 이동 => 현재 상태로는 유효성 검사가 불가능 -->
	</form>
