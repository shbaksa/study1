...
<body>	<!-- this4.jsp -->
	...
	<div class="aa" onmouseover="view(9)">안녕하세요 즐거운 월요일입니다</div>
	<div class="aa" onmouseover="view(10)">안녕하세요 즐거운 월요일입니다</div>
	<div class="aa" onmouseover="view(11)">안녕하세요 즐거운 월요일입니다</div>
	<div class="aa" onmouseover="view(12)">안녕하세요 즐거운 월요일입니다</div>
	<div class="aa" onmouseover="view(13)">안녕하세요 즐거운 월요일입니다</div>
	<div class="aa" onmouseover="view(14)">안녕하세요 즐거운 월요일입니다</div>
