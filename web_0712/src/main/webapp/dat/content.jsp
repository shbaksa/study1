...
%>    
  ...
  <table width="500" border="0" align="center">
   ...
   <%
    // dat테이블의 내용을 가져오기
    ResultSet rs2=bdao.dat_list(rs.getInt("id")); // rs는 board 테이블의 id
...
3. submit의 value를 댓글수정으로 변경 -->
   ...
   <form name="pkc" id="dat_del" method="post" action="dat_delete.jsp">
     <input type="hidden" name="id"> <!-- 삭제할때 dat where id=? -->
     <!-- board2테이블의 id추가 -->
     <input type="hidden" name="bid" value="<%=rs.getInt("id")%>"> <!-- 삭제후 content로 돌아올때 -->
